...
if use_data == 'ERA5_1x1':
    ...
    i_locations = [(all_lats.index(lat), all_lons.index(lon)) for lat,lon in locations]
else:
...
latitude_ds_file_name_idx = era5_data_dir + 'cdo_single_loc/time_combined/europe_2010_2020_130_131_132_133_135_{i_lat:05d}.nc' #{i_lon:05d}.nc'
latitude_ds_file_name_idx_monthly = era5_data_dir + 'cdo_single_loc/{year}_europe_{month}_130_131_132_133_135.nc{i_lat:05d}.nc'
latitude_ds_file_name = era5_data_dir + 'cdo_single_loc/time_combined/loc-wise/europe_2010_2020_130_131_132_133_135_lat_{lat:.2f}_lon_{lon:.2f}.nc'
